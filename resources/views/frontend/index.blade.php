                                    ...
                                    <div class="col-md-5">
                                        <div class="full slider_cont_section">
                                            ...
                                            <div class="button_section">
                                                ...
                                                <a href="{{ url('/services') }}">About Us</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-7">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 margin_top_30">
                            <div class="full margin_top_30">
                                ...
                                <p class="large">We are here to give you best in your range. You also check our
                                    testimonials our all customers are very satisfied.</p>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 margin_top_30">
                            <div class="full margin_top_30">
                                ...
                                <p class="large">Check new models and more cars find click on button that is given
                                    below..</p>
                            </div>
                            <div class="full button_section margin_top_30">
                                <a href="{{ url('/services') }}">See More</a>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 margin_top_30">
                            <div class="full center button_section margin_top_30">
                                <a class="margin_top_30" href="#testimonial">Read More</a>
                            </div>
                        </div>
                    </div>
                </div>
